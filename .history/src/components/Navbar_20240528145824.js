        ...
        <div className="collapse navbar-collapse me-5 justify-content-end" id="navbarNavDropdown">
          <ul className="navbar-nav align-items-end">
            <li className="nav-item">
              <NavLink className={({ isActive, isPending }) => aria-current="page" to={"/"}>Home</NavLink>
            </li>
            <li className="nav-item">
              <NavLink                   isPending ? "nav-link" : isActive ? "nav-link link-opacity-25" : "/" to="/issues">Issues</NavLink>
            </li>
            <li className="nav-item">
