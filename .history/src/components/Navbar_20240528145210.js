            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu position-absolute d-flex row" aria-labelledby="navbarDropdownMenuNavLink">
                <li><NavLink className={({ isActive, isPending }) =>
                  isPending ? "nav-link dropdown-item" : isActive ? "btn flex-fill" : "/"
                } to={"/"}>Action</NavLink></li>

                <li><NavLink className={({ isActive, isPending }) =>
                  isPending ? "nav-link dropdown-item" : isActive ? "btn flex-fill btn-success active" : "/"
                } to={"/"}>Contact</NavLink></li>
                <li><NavLink className={({ isActive, isPending }) =>
                  isPending ? "nav-link dropdown-item" : isActive ? "btn flex-fill active" : "/"
