      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse me-5 justify-content-end" id="navbarNavDropdown">
          <ul className="navbar-nav align-items-end">
            ...
            <li className="nav-item">
              <NavLink className={({ isActive, isPending }) =>
                isPending ? "nav-link" : isActive ? "nav-link link-opacity-25" : "nav-link link-opacity-100"
              } to="/issues">Issues</NavLink>
            </li>
            <li className="nav-item">
              <NavLink className={({ isActive, isPending }) =>
                isPending ? "btn btn-success" : isActive ? "nav-link link-opacity-25" : "nav-link link-opacity-100"
