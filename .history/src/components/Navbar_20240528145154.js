        ...
        <div className="collapse navbar-collapse me-5 justify-content-end" id="navbarNavDropdown">
          <ul className="navbar-nav align-items-end">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu position-absolute d-flex" aria-labelledby="navbarDropdownMenuNavLink">
                <li><NavLink className={({ isActive, isPending }) =>
                  isPending ? "nav-link dropdown-item" : isActive ? "btn" : "/"
                } to={"/"}>Action</NavLink></li>

                <li><NavLink className={({ isActive, isPending }) =>
                  isPending ? "nav-link dropdown-item" : isActive ? "btn btn-success active" : "/"
