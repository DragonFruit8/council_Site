            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu position-absolute d-flex row" aria-labelledby="navbarDropdownMenuNavLink">
                <li><NavLink className={({ isActive, isPending }) =>
                  isPending ? "nav-link dropdown-item d-flex flex-fill" : isActive ? "btn" : "/"
                } to={"/"}>Action</NavLink></li>

                <li><NavLink className={({ isActive, isPending }) =>
                  isPending ? "nav-link dropdown-item d-flex flex-fill" : isActive ? "btn btn-success active" : "/"
                } to={"/"}>Contact</NavLink></li>
                <li><NavLink className={({ isActive, isPending }) =>
                  isPending ? "nav-link dropdown-item d-flex flex-fill" : isActive ? "btn active" : "/"
